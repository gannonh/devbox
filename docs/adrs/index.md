...
* [Vercel snapshot resume and idle pause](0008-snapshot-resume-and-idle-pause.md) - persistent pause, source-session evidence, runtime refresh, and heartbeat-based idle control for issue [#19](https://github.com/gannonh/devbox/issues/19).
