...
/**
 * The exact audited mirror inputs from images/vercel/provenance.json. Loaded
 * from the checked-in artifact (like release validation does) so the refresh
 * workflow's provenance bump cannot leave this contract stale.
 */
export const VERCEL_IMAGE_PROVENANCE: VercelImageProvenance = JSON.parse(
  readFileSync(new URL('../../../images/vercel/provenance.json', import.meta.url), 'utf8'),
) as VercelImageProvenance;
