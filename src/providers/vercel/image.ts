...
/**
 * Generated by the reviewed image promotion workflow from public digest and
 * independent publisher/consumer smoke evidence. The workflow replaces these
 * values atomically when a later candidate is approved.
 */
